...
class TestBuilder:
    ...
    A file named report_dict.json must be created in the tests/resources directory. Unlike the analysed report, the
    ...
    def setup_class(cls):
        ...
        cls._FILE_REPORT_IN = "resources/report_dict_file.json"
        cls._EMAIL_REPORT_IN = "resources/report_dict_email.json"
        cls._URL_REPORT_IN = "resources/report_dict_url.json"
        cls._NONE_REPORT_IN = "resources/report_dict_none.json"
        # Init output file PATH
        cls._FILE_REPORT_OUT = "resources/report_str_file.json"
        cls._EMAIL_REPORT_OUT = "resources/report_str_email.json"
        cls._URL_REPORT_OUT = "resources/report_str_url.json"
        ...
        cls.blacklist_scos = yaml.safe_load(open(cls._BLACKLIST, encoding="utf-8"))
    ...
    def test_is_blacklisted(self, file_analysis):
        """
        ...
        sco_result = [
            sco
            for sco in sco_list
            if not builder.is_blacklisted("ip", sco)
            and not builder.is_blacklisted("domain", sco)
        ]
